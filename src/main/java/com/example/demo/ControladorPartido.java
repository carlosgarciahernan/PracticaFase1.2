...
public class ControladorPartido {
	...
	public String ingresar_partidos(Model modelo,@RequestParam String resultado,@RequestParam long equipo1,@RequestParam long equipo2,@RequestParam String fecha,Authentication auth) throws JSONException, MailjetException, MailjetSocketTimeoutException {
